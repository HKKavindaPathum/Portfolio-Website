    ...
    <section className="py-24 bg-zinc-950 border-t border-zinc-900 relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative max-w-4xl mx-auto">
          {/* Central Vertical Line (hidden on very small mobile, shown starting at sm) */}
          <div className="absolute left-4 sm:left-1/2 top-0 bottom-0 w-[2px] bg-gradient-to-b from-violet-600 via-indigo-600 to-zinc-900 transform sm:-translate-x-1/2" />
          ...
          <div className="space-y-12">
            {educationList.map((item, idx) => {
              ...
              return (
                ...
                >
                  {/* Glowing Node Point */}
                  <div className="absolute left-4 sm:left-1/2 w-6 h-6 rounded-full bg-zinc-950 border-4 border-violet-500 transform -translate-x-1/2 z-10 flex items-center justify-center shadow-lg shadow-violet-500/50" />

                  {/* Card Container */}
                  <div className="w-full sm:w-[calc(50%-2rem)] pl-10 sm:pl-0">
                    <div className="p-6 rounded-2xl bg-zinc-900/40 border border-zinc-800 hover:border-zinc-700/80 transition-colors shadow-lg shadow-black/20 relative group">
                      {/* Ambient card tint */}
                      ...
                      <h3 className="text-lg font-bold text-white group-hover:text-violet-400 transition-colors mb-1">
                        {item.degree}
                      </h3>

                      <div className="flex items-center gap-1.5 text-sm font-medium text-zinc-400 mb-3">
